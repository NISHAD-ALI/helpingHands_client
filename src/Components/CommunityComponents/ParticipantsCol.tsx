  ...
  return (
    <div className="p-4 bg-green-100 rounded-lg">
      ...
      <div className="flex space-x-4">
        <img src="/public/ian-dooley-d1UPkiFd04A-unsplash.jpg" alt="Ana White" className="w-12 h-12 rounded-full" />
        <img src="/public/aiony-haust-3TLl_97HNJo-unsplash.jpg" alt="Ian Blue" className="w-12 h-12 rounded-full" />
